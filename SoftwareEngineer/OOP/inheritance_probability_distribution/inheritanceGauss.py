...
class Distribution:
    ...
    def __init__(self, mu=0, sigma=1):
        ...
        Attributes:
            mean (float): represents mean value of distribution
            stdev(float): represents standard deviation
            data_list: list of floats extracted from data file
        """
...
class Gaussian(Distribution):
    ...
    def calculate_mean(self):
        """
        Function to calculate mean of data set
        :return:
         float: mean of data set
        """
...
# initialize a third gaussian distribution reading in a data txt file
